...
The software is available at [archived downloads](http://downloads.openmicroscopy.org/omero/5.1.3).
The Virtual Appliance (to allow you to test a server locally) now has its own [archived downloads](http://downloads.openmicroscopy.org/omero-virtual-appliance/5.1.3).
