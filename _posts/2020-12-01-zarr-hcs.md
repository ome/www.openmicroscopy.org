...
<iframe style="width: 100%; height: 500px" name="vizarr" src="https://hms-dbmi.github.io/vizarr/v0.1/?source=https://uk1livingobjects.ebi.ac.uk/idr/zarr/v0.1/plates/5966.zarr">
</iframe>
            ...
            <table>
                ...
                {% for row in site.data.zarr_data_2020-12-01.plates %}
                    <tr>
                        ...
                        <td>
                            <a title="Open in viewer above" target='vizarr' href="https://hms-dbmi.github.io/vizarr/v0.1/?source=https://uk1livingobjects.ebi.ac.uk/idr/zarr/v0.1/plates/{{ row.id }}.zarr">
                                view
                            </a>
                        </td>
                        <td>
                            <button class="hollow button" title="S3 endpoint. Copy to clipboard" onclick="copyTextToClipboard('https://uk1livingobjects.ebi.ac.uk/idr/zarr/v0.1/plates/{{ row.id }}.zarr')">
                                copy
                            </button>
                        </td>
                    </tr>
